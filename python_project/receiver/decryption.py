...
def decrypt_session_key(encrypted_session_key_b64: str, private_key_pem: str) -> bytes:
    ...
    session_key = private_key.decrypt(encrypted_session_key_bytes, padding.OAEP(mgf=padding.MGF1(algorithm=hashes.SHA1()), algorithm=hashes.SHA1(), label=None))
    return session_key
